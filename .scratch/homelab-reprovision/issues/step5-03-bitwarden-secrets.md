...
- [x] Create Machine Account in Bitwarden SM
- [x] Create auth token secret on cluster (`bw-auth-token`)
- [x] Fill in test secret IDs and deploy
- [x] Verify: Secret syncs to K8s Secret
